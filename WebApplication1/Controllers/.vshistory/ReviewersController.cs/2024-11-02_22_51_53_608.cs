...
namespace CodeReviewAPI
{
    ...
    public class ReviewersController : ControllerBase
    {
        ...
        // Изменить на HashSet GetReviewersForPaths и reviewers
        ...
        private bool IsPathMatch(string path, string pattern)
        {
            ...
            else if (pattern.Contains("/*"))
            {
                ...
                var expansion = path.Substring(path.IndexOf("/*") + 2);
                return path.Equals(expansion, StringComparison.OrdinalIgnoreCase);
            }
            else
            {
